...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <nav class="header-nav ms-auto">
          ...
          $sql = " SELECT * FROM order_details WHERE SHOP_ID=$SHOP_ID AND (INDI_STAT='BOOKED' OR INDI_STAT='WARNING')";
              ...
              ?>
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  <tr>
                    ...
                    if ($row['INDI_STAT'] == 'BOOKED') {
                      echo " <button name='ORDER_ID' value=$ORDER_ID class='btn btn-outline-success' >Done</button>";
                    } else {
                      echo " <button name='ORDER_ID' value=$ORDER_ID class='btn btn-outline-warning' >Done</button>";
                    }
                ...
                if (isset($_POST['ORDER_ID'])) {
                  ...
                  $_STATUS = "SHIPPED";
                  $sql = "UPDATE order_details SET INDI_STAT='$_STATUS' WHERE ORDER_ID='$ORDER_ID'";
