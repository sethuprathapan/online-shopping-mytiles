...
<body>
  ...
  <li>
   ...
   window.location.href='new_product.php'; </script>";
        //header("Location: new_product.php");

      } else {
        $shp = $_SESSION['SHOP_ID'];
        $sq = "SELECT * FROM _stock WHERE SHOP_ID='$shp' AND PRODUCT_NUMBER='$a'";
        ...
        if (empty($row)) {
          ...
          $b = "inact";
          $c = $_POST['PRODUCT_NUMBER'];
          $shp_id = $_SESSION['SHOP_ID'];
          $sql = "INSERT INTO _stock (SHOP_ID,_STATUS,PRODUCT_NUMBER) VALUES ('$shp_id','$b','$c')";
          $res = mysqli_query($conn, $sql);
          echo "<h6 style='color:green;'>your request sent successfully</h6>";
        } else {
          echo "<h6 style='color:GreenYellow;'>you have already sent/added this item </h6>";
        }
      }
    }
                                ...
                                <form id="contact-form" role="form" action="#" method="post">
                                    <div class="controls">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12"> <input type="submit" name="sub"
                                                    class="btn btn-success btn-send pt-2 btn-block " value="Add item">
                                            </div>
                                        </div>
                                    </div>
                                </form>
