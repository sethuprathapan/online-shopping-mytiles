                ...
                <div class="container">
                  ...
                  if (isset($_POST['sub'])) {
                    ...
                    if ($password == $conpassword) {
                      ...
                      $sql = "INSERT INTO _login (_USER_NAME,_PASSWORD,_ROLE) VALUES ('$email','$password','$cust')";
                      ...
                      if (!$res) {
                        ...
                        $sql = "INSERT INTO cust (EMAIL,CUST_NAME) VALUES ('$email','$name')";
                        $res = mysqli_query($conn, $sql);
                        if (!$res) {
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" action="#" method="post" novalidate>
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit" name="sub">Create
                                                Account</button>
