...
$SHIPPED="SHIPPED";
$DELIVERED="DELIVERED";
$sql=" SELECT * FROM order_details WHERE INDI_STAT='$DELIVERED' OR INDI_STAT='$SHIPPED'";
...
while($row=mysqli_fetch_array($result))
{
  ...
  $sql=" SELECT * FROM order_table WHERE ORDER_ID IN (SELECT ORDER_ID FROM order_details WHERE (INDI_STAT='$DELIVERED' OR INDI_STAT='$SHIPPED'))";
...
$ORDER_ID=$roword['ORDER_ID'];
                ...
                echo"<tbody>
                  <tr>
                    <th scope='row'>"; echo $row['ORDER_ID'];echo"</th>
                    
                    <td>"; echo $row['PRODUCT_NUMBER'];echo"</td>
                    <td>"; echo $row['NO_OF_PIECES'];echo"</td>
                    <td>"; echo $row['PRICE'];echo"</td>
                    <td>"; echo $roword['_DATETIME']; echo"</td>
                    <td>"; echo $roword['PHN']; echo"</td>
                    <td>"; echo $rowcust['CUST_NAME'],"<br>",$rowcust['EMAIL'],"<br>",$roword['ADD_RESS']; echo"</td>
                    <td>"; echo $row['INDI_STAT']; echo"</td>
