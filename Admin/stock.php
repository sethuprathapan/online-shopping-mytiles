...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section profile">
          ...
          $sql1 = "SELECT * FROM product_table WHERE PRODUCT_NUMBER IN(SELECT PRODUCT_NUMBER FROM _stock WHERE _STATUS='activ' )";
        ...
        <div class="d-sm-flex align-items-sm-center pt-2 clear">
            ...
            <div class="text-muted filter-label"><a class="btn btn-secondary" href="product.php" role="button">OUT OF
                    STOCK & REQS</a> </div>
        ...
        <section id="products">
            ...
            while ($row = mysqli_fetch_array($result)) {
              ...
              echo "rs</div>
                                      ...
                                      <input type='text' name='pronum' value='$a' hidden>
                                        ...
                                        <input class='btn btn-danger' type='submit' name='Delete' value='block' >
          ...
          if (isset($_POST['pronum'])) {
            include 'in.php';
            $N = $_POST['pronum'];
            $sql = "UPDATE _stock SET _STATUS='blked' WHERE PRODUCT_NUMBER='$N'";
