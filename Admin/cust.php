...
<li class="nav-item">
  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="users-profile.php">My Tile</a></li>
...
while($row=mysqli_fetch_array($result))
{
    ...
    $CANCEL="CANCEL";
$sql="SELECT * FROM order_details WHERE 	INDI_STAT!='$CANCEL' AND ORDER_ID in (select ORDER_ID from order_table where CUST='$S'   ) ";
...
while($rowo=mysqli_fetch_array($r))
{
  $pri+=$rowo['PRICE'];
                ...
                echo"<tbody>
                  <tr>
                    <th scope='row'>"; echo $row['CUST_ID'];echo"</th>
                    
                    <td>"; echo $row['CUST_NAME'];echo"</td>
